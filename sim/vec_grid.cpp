...
/*
if (bloque.b_x == 0 || bloque.b_x == borders[0] - 1) {
bloque.colision(bloque.b_x, l_m.list_of_particles, 0);
}
if (bloque.b_y == 0 || bloque.b_y == borders[1] - 1) {
bloque.colision(bloque.b_y, l_m.list_of_particles, 1);
}
if (bloque.b_z == 0 || bloque.b_z == borders[2] - 1) {
bloque.colision(bloque.b_z, l_m.list_of_particles, 2);
}

for (int id : bloque.lista_particulas) { l_m.list_of_particles[id].movimiento_particulas(); }

if (bloque.b_x == 0 || bloque.b_x == borders[0] - 1) {
  bloque.recinto(bloque.b_x, l_m.list_of_particles, 0);
}
if (bloque.b_y == 0 || bloque.b_y == borders[1] - 1) {
  bloque.recinto(bloque.b_y, l_m.list_of_particles, 1);
}
if (bloque.b_z == 0 || bloque.b_z == borders[2] - 1) {
  bloque.recinto(bloque.b_z, l_m.list_of_particles, 2);
}*/
