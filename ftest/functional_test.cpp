...
TEST(FunctionalTestSuite, estimated_time_test) {
  ...
  std::string path_to_program = "cd $HOME/CLionProjects/Arq-Comp-G14/cmake-build-release/fluid && ./fluid 1000 ../../large.fld ../../out.fld"; // Reemplaza esto con la ruta a tu programa
